...
namespace watchtower.Services {
    ...
    public class HostedEventProcessService : BackgroundService {

        private readonly ILogger<HostedEventProcessService> _Logger;
        private readonly IBackgroundTaskQueue _Queue;
        private readonly IEventHandler _Handler;

        public HostedEventProcessService(ILogger<HostedEventProcessService> logger,
